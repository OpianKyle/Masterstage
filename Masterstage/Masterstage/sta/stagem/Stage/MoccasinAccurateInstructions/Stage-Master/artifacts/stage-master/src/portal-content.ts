...
export const portalResources = [
  ...
  {
    type: "Reseller bundle",
    title: "Download the Reseller Bundle",
    description: "One ZIP containing the complete course package, videos, slide deck, and reseller launch files.",
    assetId: "reseller-bundle",
    requiredTier: "reseller",
  },
];