...
function LandingPage() {
  ...
  return (
    <div className="grain min-h-[100dvh] bg-[var(--paper)]">
      ...
      <main id="top">
        <section className="relative isolate flex min-h-[680px] items-end overflow-hidden bg-[var(--navy)] pb-16 pt-32 text-white sm:min-h-[760px] lg:min-h-[780px] lg:pb-20">
          ...
          <div className="mx-auto w-full max-w-[1380px] px-6 lg:px-12">
            <div className="max-w-3xl">
              ...
              <h1 className="reveal reveal-delay-1 display-font max-w-4xl text-4xl font-extrabold leading-[.98] sm:text-6xl lg:text-[4.5rem]">Are You Struggling With Public Speaking? <span className="text-[var(--gold)]">Turn Your Voice Into A High-Ticket Asset.</span></h1>
              ...
              <p className="mt-4 text-sm leading-7 text-slate-600">
               ...
               {access.configured && (
                 <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                   <button onClick={() => handleCheckout('personal')} className="btn-gold flex items-center justify-center gap-3 px-6 py-4 text-xs font-bold uppercase tracking-[.15em]">
                     Get Personal Use — $47 <ArrowRight size={15} />
                   </button>
                   <button onClick={() => handleCheckout('reseller')} className="flex items-center justify-center gap-3 border border-[var(--navy)] bg-[var(--navy)] px-6 py-4 text-xs font-bold uppercase tracking-[.15em] text-white transition hover:bg-[var(--blue-deep)]">
                     Get Reseller Rights — $147 <ArrowRight size={15} />
                   </button>
                 </div>
               )}
            </div>
                ...
                <div className="mt-6 max-w-3xl">
                  ...
                  <div className="mt-5 flex flex-wrap items-center gap-x-5 gap-y-3 text-xs text-slate-300">
                   ...
                   <div className="mt-6 flex flex-wrap gap-3">
                     {isReseller ? (
                       <a
                         href="/api/portal/content/reseller-bundle"
                         download
                         className="flex items-center gap-3 bg-[var(--gold)] px-5 py-3 text-[10px] font-bold uppercase tracking-[.15em] text-[var(--navy)] transition hover:bg-[#e8c574]"
                       >
                         <Download size={15} /> Download Reseller ZIP
                       </a>
                     ) : (
                       <button
                         onClick={() => handleCheckout('reseller')}
                         className="flex items-center gap-3 border border-[var(--gold)] px-5 py-3 text-[10px] font-bold uppercase tracking-[.15em] text-[var(--gold)] transition hover:bg-[var(--gold)] hover:text-[var(--navy)]"
                       >
                         Upgrade to Reseller Rights — $147 <ArrowRight size={15} />
                       </button>
                     )}
                   </div>
                </div>
                ...
                <div className="min-w-0">
                  <div className="-mt-7 overflow-hidden border border-black/10 bg-black shadow-[0_18px_45px_rgba(15,23,42,.18)] transition duration-300 hover:shadow-[0_24px_55px_rgba(15,23,42,.25)]">
                    <video
                      ...
                      controls
                      controlsList={isReseller ? undefined : 'nodownload noplaybackrate'}
                      onContextMenu={isReseller ? undefined : (event) => event.preventDefault()}
                      preload="metadata"
